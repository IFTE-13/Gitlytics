...
export function Header({
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (
        (isSlash || ((e.metaKey || e.ctrlKey) && isK)) &&
    ...
    <section className="relative w-full border-b border-border bg-background technical-grid pt-10 pb-16 lg:pt-16 lg:pb-20 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 relative min-h-[520px] sm:min-h-[580px] lg:min-h-[640px] flex items-center justify-center">
            
            {/* 3D Particle Sphere Canvas */}
            <div className="w-full h-[520px] sm:h-[580px] lg:h-[640px] relative flex items-center justify-center">
              <HeroParticleSphere
